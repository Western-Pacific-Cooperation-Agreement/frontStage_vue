<template>
  ...
  <el-button type="danger" v-if="!applied" @click="dialogVisible = true">报名活动</el-button>
...
<script>
  import {getActivityInfo,getUserApplied,getUserCollected,addCollectedAct,addSignUpAct,
    cancelCollectedAct,cancelSignUpAct,getUserInfo} from '@/api/act'
